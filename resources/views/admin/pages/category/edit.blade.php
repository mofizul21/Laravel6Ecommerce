    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-12 mb-4">
                ...
                <form class="user" action="{{route('admin.category.update', $categories->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <br>
                                <img src="{{asset('public/images/categories/'.$categories->image)}}" alt="" height="70">
                                <br>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="submit" class="btn btn-primary btn-user btn-block" value="Update Category">
                        </div>
                    </div>
