    ...
    <div class="content-wrapper">
        ...
        <div class="invoice-header">
            <div class="float-left site-logo">
                <img src="{{ asset('public/images/favicon.png') }}" alt="">
            </div>
            <div class="float-right site-address">
                <h4>TPN Mobile</h4>
                <p>Razarbagan, Satkhira College Road</p>
                <p>Phone: <a href="">014589654123</a></p>
                <p>Email: <a href="mailto:contact@themepack.net">contact@themepack.net</a></p>
            </div>
            ...
            <table class="table table-bordered table-stripe">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{URL::to('/products/'.$cart->product->slug)}}">{{ $cart->product->title }}</a>
                        </td>
                        <td>
